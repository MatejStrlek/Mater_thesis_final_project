...
import { apiEnrollmentTestStudent, course, courseId } from '../../utils/test-data';
...
test.describe('Enrollments API', () => {
  test.afterEach(async ({ request }) => {
    ...
    const { accessToken } = await loginViaApi(request, apiEnrollmentTestStudent.username, apiEnrollmentTestStudent.password);
